...
export const neighborhoodDocuments: ListItem[] = [
  {
  ...
  {
    id: 'leafy-spurge-treatments',
    label: 'Leafy Spurge and other Weed Treatments',
    path: '/documents/ley-subdivision/weed-treatments.pdf',
    iconType: ListIconTypes.DOCUMENT,
  },
]
